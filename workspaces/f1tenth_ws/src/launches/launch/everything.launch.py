...
def generate_launch_description():
    ...
    mux_out      = LaunchConfiguration('mux_out')   # mux output topic (default: ackermann_cmd)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('mux_out',      default_value='ackermann_cmd'),
        ...
        # 2) teleop_twist_joy -> /cmd_vel (uses f1tenth_teleop YAML in source)
        Node(
        ...
        # 3) Twist -> Ackermann : /cmd_vel -> /cmd_teleop
        Node(
        ...
        # 4) Ackermann mux (topics+locks from ackermann_mux source)
        Node(
